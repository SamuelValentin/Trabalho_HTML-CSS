...
/*
Como arrumar a quantidade:
A pessoa coloca a quantidade que ela quer e na hora de mandar eu altero a quantidade do localstorage

Se a pessoa escolher um produto que já está no carrinho eu tambem aumento, assim não tem duplicamento de items e
eu nao preciso arrumar a parte do btnRemove tirar varios items de msm id
*/
     ...
     if (typeof(Storage) !== "undefined") {
          ...
          if (produtosCarrinho == null){
              //document.write("<h3>Nenhum produto foi adicionado.</h3>");
               ...
               var title = document.createElement("H1");
               var texto = document.createTextNode("Seu carrinho de commpras: ");
               title.appendChild(texto);
               divTitle.appendChild(title);
               header.appendChild(divTitle)
